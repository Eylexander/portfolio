...
import { BiLogoGoLang, BiLogoReact, BiLogoNodejs, BiLogoJava, BiLogoTypescript, BiLogoKubernetes, BiLogoDocker, BiLogoMongodb, BiLogoTailwindCss } from "react-icons/bi";
          ...
          <Card>
            <article className="relative flex flex-col md:flex-row w-full h-full p-4 md:p-8">
              ...
              <div>
                ...
                <p className="mb-4 leading-8 duration-150 text-zinc-400 group-hover:text-zinc-300 text-justify">
